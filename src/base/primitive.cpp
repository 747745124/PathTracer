...
Primitives _get_primitives_from_io(const ObjIO *io)
{
    ...
    {
        Materials materials;
        std::cout << "This object has " << io->numMaterials << " materials" << std::endl;
        ...
        case ObjType::SPHERE_OBJ:
        {
            ...
            if (io->numMaterials != 0)
                throw std::runtime_error("No material for sphere or Too many materials for sphere");
        ...
        case ObjType::POLYSET_OBJ:
        {
            ...
            for (int i = 0; i < polyset_io->numPolys; i++)
            {
                ...
                if (polyset_io->materialBinding == MaterialBinding::PER_OBJECT_MATERIAL)
                {
                ...
                else if (polyset_io->materialBinding == MaterialBinding::PER_VERTEX_MATERIAL)
                {
