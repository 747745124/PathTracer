...
// 1 for z
[[deprecated]] static mat4 getPerspectiveMatLH(float fov, float aspect,
...
[[deprecated]] static mat4 getPerspectiveMatRH(float fov, float aspect,
...
[[deprecated]] static mat4 getOrthoMatRH(float left, float right, float bottom,
